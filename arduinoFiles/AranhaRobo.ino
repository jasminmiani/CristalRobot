...
// Declara a pinagem do indicador de bateria
...
void loop() { // Roda o programa principal que faz o gerenciamento do comportamento da Cristal
  ...
  if (jsondata["connect"]) {
    ...
    WalkRight();
  } else if (jsondata["walk_front_left"]) {
    WalkFrontLeft();
  } else if (jsondata["walk_front_right"]) {
    WalkFrontRight();
  } else if (jsondata["walk_back_left"]) {
    WalkBackLeft();
  } else if (jsondata["walk_back_right"]) {
    WalkBackRight();
  } else if (jsondata["walk_turn_front_left"]) {
    WalkTurnFrontLeft();
  } else if (jsondata["walk_turn_front_right"]) {
    WalkTurnFrontRight();
  } else if (jsondata["walk_turn_back_left"]) {
    WalkTurnBackLeft();
  } else if (jsondata["walk_turn_back_right"]) {
    WalkTurnBackRight();
...
// Sequência executada para dar um passo para Esqueda
...
// Sequência executada para dar um passo para Diagonal Frente-Esquerda

void WalkFrontLeft() {
}

// Sequência executada para dar um passo para Diagonal Frente-Direita

void WalkFrontRight() {
}

// Sequência executada para dar um passo para Diagonal Trás-Esquerda

void WalkBackLeft() {
}

// Sequência executada para dar um passo para Diagonal Trás-Direita

void WalkBackRight() {
}

// Sequência executada para dar um passo para Frente virando a Esquerda

void WalkTurnFrontLeft() {
}

// Sequência executada para dar um passo para Frente virando a Direita

void WalkTurnFrontRight() {
}

// Sequência executada para dar um passo para Trás virando a Esquerda

void WalkTurnBackLeft() {
}

// Sequência executada para dar um passo para Trás virando a Direita
